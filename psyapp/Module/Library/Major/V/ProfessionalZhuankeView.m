...
@interface ProfessionalZhuankeView()<RATreeViewDataSource,RATreeViewDelegate>
...
@implementation ProfessionalZhuankeView
...
-(void)initTreeView{
    ...
    self.raTreeView.rowsExpandingAnimation = RATreeViewRowAnimationNone;
...
-(void)loadData{
    [QSLoadingView show];
    [CareerService getProfessionalList:@"1" majorName:@"" success:^(id data) {

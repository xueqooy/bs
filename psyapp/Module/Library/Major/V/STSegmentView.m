...
- (void)setSliderHeight:(CGFloat)sliderHeight {
    ...
    UIView *trackView = [UIView new];
    trackView.backgroundColor = mHexColor(@"ebebeb");
    trackView.frame = CGRectMake(0, self.bounds.size.height - sliderHeight, mScreenWidth, 0.5);

...
#import "TCKeyChainHelper.h"
@implementation FEDeviceManager
...
+ (NSString *)getDiviceUUIDFromKeyChain {
    NSString *uuid = [TCKeyChainHelper load:@"com.cheersbrain.psyapp.uuid"];
    if ([NSString isEmptyString:uuid]) {
        uuid = [self getDiviceUUID];
        [TCKeyChainHelper save:@"com.cheersbrain.psyapp.uuid" data:uuid];
    }
    //TEST
//    uuid = @"B3CBA287-C35C-4EFF-9725-E2919C722566";
    return uuid;
}
...
+ (NSString *)debug_getDiviceUUID {
    return nil;
//    if (DEBUG) {
//        NSString *randomUUID = @"B3CBA287-C35C-4EFF-9725-E2919C7";
//        NSInteger random = arc4random_uniform(100000);
//        randomUUID = [randomUUID stringByAppendingFormat:@"%li", random];
//        return randomUUID;
//    } else {
//        return [self getDiviceUUIDFromKeyChain];
//    }
}

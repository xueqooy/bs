//
//  FEEqualSpaceFlowLayoutEvolve.m
...
@interface FEEqualSpaceFlowLayoutEvolve(){
    //在居中对齐的时候需要知道这行所有cell的宽度总和
    CGFloat _sumWidth ;
}
@end

@implementation FEEqualSpaceFlowLayoutEvolve
...
-(instancetype)init{
    ...
    if (self){
        ...
        self.sectionInset = UIEdgeInsetsMake(10, 0, 10, 10);
        _betweenOfCell = 10;

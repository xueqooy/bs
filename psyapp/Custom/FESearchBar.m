...
//    [self setImage:nil forSearchBarIcon:UISearchBarIconSearch state:UIControlStateNormal];
    ...
    self.qmui_textColor = UIColor.fe_contentBackgroundColor;
    self.qmui_placeholderColor = [UIColor.fe_contentBackgroundColor colorWithAlphaComponent:0.5];
